...
local function interface()
  local settings = {
    key = "balpal_settings",
    title = "Имбалансный друид",
    width = 300,
    height = 500,
    resize = true,
    show = false,
    template = {
      {type = "header", text = "               Настройки балонки"},
      {
        type = "text",
        text = "Всё шо ты тут поменяешь, активно сразу."
      },
      {type = "rule"},
      ...
      -- { key = 'input', type = 'input', text = 'TextBox', desc = 'Description of Textbox' },
      {
        key = "usehealpot",
        type = "checkbox",
        text = "Береговое зелье омоложения",
        desc = "Юзануть Береговое зелье омоложения есть огурцы на кд\нет3"
      },
      {
        key = "intpercent",
        type = "spinner",
      ...
      {type = "rule"},
	  {type = "header", text = "Всякое полезное" },
      {type = "text", text = "!!! Азеритки меняют ротацию, ставь только если есть. !!!"},
      {key = "autoRacial", type = "checkbox", text = "Racial", desc = "Юзать рассовою авбилку (Только для троля)"},
      { key = "arcanicPulsar", type = "checkbox", text = "Магический пульсар", desc = "Если у тебя есть эти трейты в азеритке ставь галочку"},
      {key = "az_ss", type = "checkbox", text = "Стремительные звезды", desc = "Если у тебя есть эти трейты в азеритке ставь галочку"},
      {key = "az_ls", type = "checkbox", text = "Живость духа", desc = "Если у тебя есть эти трейты в азеритке ставь галочку"},
      {key = "innervateTarget", type = "input", default = "", text = "Авто иннер, оставь пустым и он сам будет давать на кого то", desc = ""},
      {type = "rule"},
      {
        key = "autoPotion",
        type = "dropdown",
        text = "Potion",
        desc = "Авто зелья\препоты",
        default = "pot_a",
        list = {
          {key = "pot_a", text = "Нет"},
          {key = "pot_b", text = "Боевое зелье интеллекта"},
          {key = "pot_c", text = "Дренорское зелье интеллекта"},
          {key = "pot_d", text = "Зелье смертоносного прилива"}
        }
      },
      {
        key = "autoRune",
        ...
        list = {
          {key = "rune_a", text = "Нет"},
          {key = "rune_b", text = "Шепчущий кристалл Орелия"}
        }
      }
    }
  }
  ...
  dark_addon.interface.buttons.add_toggle(
    {
      name = "FON",
      label = "Авто деревяшки (мусор талант даже не думай)",
      on = {
        label = "Полено",
        color = dark_addon.interface.color.orange,
        color2 = dark_addon.interface.color.ratio(dark_addon.interface.color.dark_orange, 0.7)
...
dark_addon.rotation.register(
  {
    ...
    name = "balance",
    label = "PAL profile translated by kirasaka",
    combat = combat,
    gcd = gcd,
    resting = resting,
    interface = interface
