...
fontObject:SetFont("Interface\\Addons\\feral\\butwhy\\core\\media\\Consolas.ttf", 12)
...
function dark_addon.log(string, ...)
  ...
  print('|cff' .. dark_addon.color .. '[FlexDruid]|r ' .. formatted)
end

function dark_addon.error(...)
  print('|cff' .. dark_addon.color .. '[FlexDruid]|r |cffc32425' .. join(...) .. '|r')
end
