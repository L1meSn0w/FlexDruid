...
--    end
    ...
    if castable(SB.Frostbrand) and -spell(SB.Frostbrand) == 0 and talent(4,2) and not player.buff(SB.Frostbrand).up then
    ...
    if castable(SB.Frostbrand) and -spell(SB.Frostbrand) == 0 and talent(4,2) and player.buff(SB.Frostbrand).remains < 4.5 then
        return cast(SB.Frostbrand)
    end          
    ...
    if castable(SB.LavaLash) and -spell(SB.LavaLash) == 0 and (player.power.maelstrom.actual > 40 or (player.power.maelstrom.actual > 50 and talent(6,2))) then
